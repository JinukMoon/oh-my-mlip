...
| NequIP-OAM-XL | NequIP | on-demand-hf | no | [GitHub](https://github.com/mir-group/nequip){ .md-button .omm-repo } |
| NequIP-OAM-L | NequIP | on-demand-hf | no | [GitHub](https://github.com/mir-group/nequip){ .md-button .omm-repo } |
| Allegro-OAM-L | Allegro | on-demand-hf | no | [GitHub](https://github.com/mir-group/allegro){ .md-button .omm-repo } |
| Nequix-MP-1 | Nequix | on-demand-hf | no | [GitHub](https://github.com/atomicarchitects/nequix){ .md-button .omm-repo } |
...
| eSEN-30M-OAM | fairchemv1 | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| EqV3-OMatMPtrjSalex | EquiformerV3 | on-demand-hf | no | [GitHub](https://github.com/atomicarchitects/equiformer_v3){ .md-button .omm-repo } |
| UMA-m-1p1-OC20 | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-m-1p1-OMAT | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-s-1p1-OC20 | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-s-1p1-OMAT | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-s-1p2-OC20 | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-s-1p2-OC22 | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
| UMA-s-1p2-OC25 | UMA | on-demand-hf | yes | [GitHub](https://github.com/facebookresearch/fairchem){ .md-button .omm-repo } |
